...
- [x] Evaluate hypotheses across chronological development folds
- [x] Lock research hypotheses from development-only chronological evidence
- [x] Evaluate locked hypotheses on pristine historical/OOS data
