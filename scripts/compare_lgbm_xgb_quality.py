...
INPUT = Path("data/processed/momentum_quality_5r.csv")
...
required = {"timestamp", "quality_5r", *FEATURES}
...
for fold in range(4):
    ...
    y_train = train["quality_5r"]
    X_test = test[FEATURES]
    y_test = test["quality_5r"]
