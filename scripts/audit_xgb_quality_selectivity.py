"""Audit OOS XGBoost probabilities by selectivity threshold."""
...
OUTPUT_PATH = Path(
    "reports/xgb_quality_selectivity_oos.csv"
)
...
def main() -> None:
    print("=== XGBoost OOS Selectivity Audit ===")
